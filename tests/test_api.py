...
async def test_fontes_lista_os_conectores(api):
    ...
    assert nomes == {"camara", "senado", "bacen", "brasilapi", "conab", "diarios", "focus", "ibge", "sus", "tesouro", "sidra", "aneel", "mme", "antt", "ipeadata", "obrasgov", "cotacoes", "ons", "inpe", "transparencia", "pncp", "b3", "infodengue", "comex", "tesourodireto", "ana", "anp", "loterias", "mundo", "notaparana", "rosario", "alexfarma", "extrafarma", "nissei", "datajud", "educacao", "seguranca", "tse"}
