  ...
  return (
    <div>
      <CadernoHeader
        ...
        resumo="O voto nominal de cada parlamentar no plenário, com o placar. Votações simbólicas (aprovadas de viva voz) não registram voto individual — a página pula pra primeira nominal, e o aviso explica quando não há."
      />
